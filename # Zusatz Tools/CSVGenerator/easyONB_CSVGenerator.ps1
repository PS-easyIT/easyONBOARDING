...
try {
    ...
    $requiredControls = @(
        ...
        "cmbOffice", "txtPosition", "cmbBusinessUnit",
        "txtPersonalNumber", "dtpTermination", "dtpStartWorkDate", "chkTL", "chkAL", 
        "btnSave", "btnClose", "picLogo", "txtNotes"
    )
    
    $optionalControls = @("cmbStatus")
...
$controls.btnSave.Add_Click({
    ...
    try {
        ...
        $data = [PSCustomObject]@{
            ...
            'Supervisor'     = $controls.txtSupervisor.Text.Trim()
            ...
            # Hardware section
            'PCModel'        = $controls.cmbPCModel.Text.Trim()
            'PCKeyboard'     = $controls.cmbPCKeyboard.Text.Trim()
            'PCOperatingSystem' = $controls.cmbOperatingSystem.Text.Trim()
            'AdminRightsReason' = $controls.txtAdminRights.Text.Trim()
            'DockingStation' = $controls.chkDockingStation.IsChecked
            'MonitorCount'   = $controls.numMonitors.Text.Trim()
            'HeadsetModel'   = $controls.cmbHeadset.Text.Trim()
            'OtherHeadsetModel' = $controls.txtOtherHeadset.Text.Trim()
            'Webcam'         = $controls.chkWebcam.IsChecked
            'Mouse'          = $controls.chkMouse.IsChecked
            'Keyboard'       = $controls.chkKeyboard.IsChecked
            'DeskPhone'      = $controls.chkDeskPhone.IsChecked
            'PhoneModel'     = $controls.txtPhoneModel.Text.Trim()
            'MobilePhone'    = $controls.chkMobilePhone.IsChecked
            
            # Software section
            'GenesisInstall' = $controls.chkGenesisInstall.IsChecked
            'GenesisLicense' = $controls.cmbGenesisLicense.Text.Trim()
            'CommissionDependent' = $controls.chkCommissionDependent.IsChecked
            'SageInstall'    = $controls.chkSageInstall.IsChecked
            'SageLicense'    = $controls.cmbSageLicense.Text.Trim()
            
            # Telephony section
            'PersonalExtension' = $controls.chkPersonalExtension.IsChecked
            'PersonalFax'    = $controls.txtPersonalFax.Text.Trim()
            'GroupAssignment' = $controls.cmbGroupAssignment.Text.Trim()
            
            # Access and tools
            'InternalWikiAccess' = $controls.chkInternalWiki.IsChecked
            'ConfluenceAccess' = $controls.chkConfluence.IsChecked
            'JiraAccess'     = $controls.chkJira.IsChecked
            'ToolsDetails'   = $controls.txtToolsDetails.Text.Trim()
            
            # Other access
            'VPNAccess'      = $controls.chkVPN.IsChecked
            'TerminalServer' = $controls.chkTerminalServer.IsChecked
            'MS365OnTerminal' = $controls.chkMS365Terminal.IsChecked
            'ShopAccess'     = $controls.chkShop.IsChecked
            'OtherAccess'    = $controls.txtOtherAccess.Text.Trim()
        }
        ...
        $controls.cmbPCModel.SelectedIndex = -1
        $controls.cmbPCKeyboard.SelectedIndex = -1
        $controls.cmbOperatingSystem.SelectedIndex = -1
        $controls.txtAdminRights.Text = ""
        $controls.chkDockingStation.IsChecked = $false
        $controls.numMonitors.Text = ""
        $controls.cmbHeadset.SelectedIndex = -1
        $controls.txtOtherHeadset.Text = ""
        $controls.chkWebcam.IsChecked = $false
        $controls.chkMouse.IsChecked = $false
        $controls.chkKeyboard.IsChecked = $false
        $controls.chkDeskPhone.IsChecked = $false
        $controls.txtPhoneModel.Text = ""
        $controls.chkMobilePhone.IsChecked = $false
        
        # Clear software section
        $controls.chkGenesisInstall.IsChecked = $false
        $controls.cmbGenesisLicense.SelectedIndex = -1
        $controls.chkCommissionDependent.IsChecked = $false
        $controls.chkSageInstall.IsChecked = $false
        $controls.cmbSageLicense.SelectedIndex = -1
        
        # Clear telephony section
        $controls.chkPersonalExtension.IsChecked = $false
        $controls.txtPersonalFax.Text = ""
        $controls.cmbGroupAssignment.SelectedIndex = -1
        
        # Clear access sections
        $controls.chkInternalWiki.IsChecked = $false
        $controls.chkConfluence.IsChecked = $false
        $controls.chkJira.IsChecked = $false
        $controls.txtToolsDetails.Text = ""
        $controls.chkVPN.IsChecked = $false
        $controls.chkTerminalServer.IsChecked = $false
        $controls.chkMS365Terminal.IsChecked = $false
        $controls.chkShop.IsChecked = $false
        $controls.txtOtherAccess.Text = ""
    } catch {
