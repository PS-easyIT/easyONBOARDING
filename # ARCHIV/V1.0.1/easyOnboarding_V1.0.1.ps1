...
param(
    ...
    [string]$License = "",
    [switch]$External,
    [string]$ScriptINIPath = "easyONBOARDINGConfig.ini"  # Bitte exakten Pfad angeben!
)
...
function Show-OnboardingForm {
    ...
    $txtAblaufdatum = AddTextBox $panelLeft "" 150 $yLeft; $yLeft += 25
    AddLabel $panelLeft "Not  effective  when  account  disabled!" 150 $yLeft -Bold | Out-Null; $yLeft += 20
    ...
    AddLabel $panelLeft "* REQUIRED FIELDS" 12 $yLeft -Bold | Out-Null; $yLeft += 45
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCTX/2X3FP+EoIC
# nUAkXdqSz55CdLMcCQjXJ6yNjfPwpKCCFhcwggMQMIIB+KADAgECAhB3jzsyX9Cg
...
# DQEJBDEiBCA1jriOjUMRNfL4JkzDf6IEQ4RRD/gqzmzypnO5nui0mzANBgkqhkiG
# 9w0BAQEFAASCAQAnk2/gszb8r6MkAZSuaIlumZjiYYgfKXKq0jRA9iEaamM1PyRT
# KsYbj2ShXbQUS5IAzXYgb0TvEUIJU1KpFMtx7Ka9y7XeGslTpv0/ERjlEoQ4uvsq
# bBRyF6RmjEptDi0uu6+KAHoGO8i29KPr33wC0PfVBvPlou+Fl63VKevpo5TqkaSD
# uIlGdMXnoS1GPjh6bvPRu2MWlojkyxd7kgCAgR5/i3B2PjhLFpvuzL+cpYY/kmR3
# XRum8kFko8UZI0RZ9xkz6eU80SRcBQujF4WumtEbtgh4P7SsZmlfKU39xl/qN+5L
# LS09dZz7aMNfrJ/oTqH7DrFRmODvA3UT5nouoYIDIDCCAxwGCSqGSIb3DQEJBjGC
# Aw0wggMJAgEBMHcwYzELMAkGA1UEBhMCVVMxFzAVBgNVBAoTDkRpZ2lDZXJ0LCBJ
# bmMuMTswOQYDVQQDEzJEaWdpQ2VydCBUcnVzdGVkIEc0IFJTQTQwOTYgU0hBMjU2
# IFRpbWVTdGFtcGluZyBDQQIQC65mvFq6f5WHxvnpBOMzBDANBglghkgBZQMEAgEF
# AKBpMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTI1
# MDcwNTEwMTE1OFowLwYJKoZIhvcNAQkEMSIEICNZ9IBcL3mxPrXmo6F9JR1l1STi
# qkJLZVPq8vVeP6VJMA0GCSqGSIb3DQEBAQUABIICAKTExvmjsrIKu6dAv0DNdIos
# VBohLa25vm3OiOda6DzmPvKYHkT/6SCVYDvlli9uDR/NEj3PAiTAZBAH2mmtTrLn
# 239RH7ej3RRzFeenoCmwk0VDQvcwA1YXILiFQAOarGfa9iamI2ynHkpo35I1q6fR
# WSrMywZLjSaT7K7x4QuvTrpzhfupJTgKVy21QuBANvRg6VQov+Qf/awm4HUPsuNx
# ONwcPyJi7IWMHuKAOpG1aSY7WSko3PRlFJ92dFkJuu0Zj2VxSElBZblgBw5xU6no
# n5TBGtM6oaeGyfGvzE7IYoUdDX40JZWINq79dow9kGr6T4trza7DuOlfPqay8qJg
# Rwz99ykWx7SK6vC+317sNx+iScZ5bQQb0TmRoXycBU0iA0/j6nWA2eLvq40801Ip
# 6FkJzdMAD+u6I39zj9U53lxH+TilxYFCz5GhcWbSmbl/Bu3zdK/j09mnHqKZ/HyE
# WQpXwrrJ1Q1noVX0CyZMpnIt/PLgM6BNSG/GEyEqEHuI6Ed7ehhdAAUA2Jp3HFtp
# TRPQ5MTfxgjTR2lsQxf7EugIlw9faI8IySPW08V5I1YRijvuSbkkHDUhdqrwOn57
# CQ8WIuMAGeM9u0iK0Fm41G17Bk9E67K62QZV0HqlEziFtENjnjbwX0V4cc60O4Yf
# 9+UnsDD34OrxnuV0sCJm
